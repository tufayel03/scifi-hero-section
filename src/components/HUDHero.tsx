...
export function HUDHero({ onShopClick }: { onShopClick: () => void }) {
  ...
  return (
    <section className="bg-transparent pointer-events-none min-h-[100vh] w-full flex items-center justify-center font-rajdhani overflow-hidden relative selection:bg-[#FF1A00] selection:text-white pb-10 pt-10 xl:pt-0 z-10">
      ...
      {/* Unified Scaled HUD Container */}
      <div className="relative w-[1920px] h-[1080px] flex items-center justify-center scale-[0.27] min-[400px]:scale-[0.32] sm:scale-[0.4] md:scale-[0.45] lg:scale-[0.5] xl:scale-[0.55] 2xl:scale-[0.6] origin-top md:origin-center mt-[-50px] md:mt-[-100px] lg:mt-[-100px] xl:mt-[-150px] 2xl:mt-[-200px] mb-[-600px] md:mb-[-400px] lg:mb-[-150px] xl:mb-[-200px] 2xl:mb-[-300px]">
        <CockpitFrame />

        <div className="relative z-20 w-[1400px] flex flex-row items-center justify-center gap-8 pointer-events-auto mt-0">

          {/* LEFT SECTION */}
          <div className="w-[350px] flex flex-col items-center flex-shrink-0 relative">
            <div className="w-[80%] mb-12 self-start pl-8 block">
          ...
          <div className="flex-1 flex flex-col items-center justify-center relative xl:mx-[100px] mt-10 xl:mt-0 min-h-[700px] z-20">
            ...
            <div className="absolute top-[-80px] flex flex-col items-center w-full">
              ...
              <div className="w-[500px] h-[25px] border-b-2 border-t-2 border-x-2 border-[#FF1A00]/80 mt-6 flex justify-between items-end px-3 py-1 bg-[#FF1A00]/10 relative">
            ...
            <div className="relative w-[350px] h-[350px] md:w-[450px] md:h-[450px] lg:w-[600px] lg:h-[600px] flex items-center justify-center mt-20 xl:mt-0 xl:-translate-y-8">
              ...
              {/* HORIZONTAL NAVIGATION (Left & Right moved to center) */}
              <div className="absolute top-[480px] w-full flex justify-center items-center pointer-events-none gap-[400px] z-20">
                {/* LEFT NAV */}
                ...
                {/* RIGHT NAV */}
                <div className="w-[200px] h-[350px] bg-[#FF1A00]/10 border-r-4 border-[#FF1A00] flex flex-col justify-center gap-3 p-4 z-30 transition-all hover:bg-[#FF1A00]/20 group backdrop-blur-[2px] pointer-events-auto" style={{ clipPath: 'polygon(0 20%, 100% 0, 100% 100%, 0 80%)' }}>
                  <div className="absolute inset-0 bg-[#FF1A00]/10 opacity-0 group-hover:opacity-100 blur-xl transition-opacity"></div>
            ...
            <div className="absolute bottom-[-160px] flex flex-col items-center">
              <div className="w-[100px] h-[40px] border-l-4 border-r-4 border-[#FF1A00] mt-[-20px] flex items-center justify-center opacity-50 relative">
                <div className="w-[20px] h-full bg-[#FF1A00]/20 block"></div>
          ...
          {/* RIGHT SECTION */}
          <div className="w-[350px] flex flex-col items-center flex-shrink-0 relative">
            <div className="w-[80%] mb-20 self-end pr-8 block">
